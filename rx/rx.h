/* $Id: rx.h,v 1.34 2007/06/28 18:28:02 lha Exp $ */
...
struct rx_service {
    ...
    int32_t (*executeRequestProc) (struct rx_call *);
				        ...
				        * is received */
    void (*destroyConnProc)(struct rx_connection * conn);
...
void *	rx_getConnRock(struct rx_connection *);
void	rx_setConnRock(struct rx_connection *, void *);
