...
m4_foreach_w([rk_func],[asprintf vasprintf asnprintf vasnprintf],[AC_NEED_PROTO([
	#include <stdio.h>
	#include <string.h>],
	rk_func)])
...
m4_foreach_w([rk_func],[strndup strsep strtok_r],[AC_NEED_PROTO([#include <string.h>], rk_func)])

m4_foreach_w([rk_func],[strsvis strunvis strvis strvisx svis unvis vis],[AC_NEED_PROTO([#ifdef HAVE_VIS_H
#include <vis.h>
#endif], rk_func)])
